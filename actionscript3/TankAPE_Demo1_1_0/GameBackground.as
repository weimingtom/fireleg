package
{
	...
	public class GameBackground
	{
		...
		public function init():void {				
			...
			var floor:RectangleParticle = new RectangleParticle(600,390,1700,100,0,true,1,0,friction);
			floor.setStyle(0,0,0,0x999999);
			terrainA.addParticle(floor);
			
			// pyramid of boxes
			var box0:RectangleParticle = new RectangleParticle(600,337,600,7,0,true,10,0,friction);
			box0.setStyle(1,0x999999,1,0x336699);
			terrainA.addParticle(box0);
			
			var box1:RectangleParticle = new RectangleParticle(600,330,500,7,0,true,10,0,friction);
			...
			// left side floor
			var floor2:RectangleParticle = new RectangleParticle(-100,390,1100,100,0.3,true,1,0,friction);
			floor2.setStyle(0,0,0,0x999999);
			terrainB.addParticle(floor2);
			
			var floor3:RectangleParticle = new RectangleParticle(-959,232,700,100,0,true,1,0,friction);
